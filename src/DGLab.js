...
(function (_, Kotlin) {
  ...
  KDataUtils.prototype.parseSetupData_964n8l$ = function (bArr) {
    ...
    }var g = this.byteArrayToString_fqrh44$(this.parseByteArray_0(bArr));
    return new Int32Array([toInt(g.substring(5, 16), 2), toInt(g.substring(16), 2)]);
  };
  KDataUtils.prototype.byteArrayToString_fqrh44$ = function (bArr) {
  ...
  KDataUtils.prototype.dfu_964n8l$ = function (bArr) {
    ...
    if (toInt(this.byteArrayToString_fqrh44$(f), 2) === 1) {
      return new Int32Array([0, 1]);
    }var g = this.byteArrayToString_fqrh44$(f);
